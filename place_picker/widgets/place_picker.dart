...
import 'package:yeah/taxi/11.dart';
...
import 'package:yeah/apis/taxi_api.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: PlacePicker("AIzaSyD0Zwmr6ERIT0VGzsvBof8E9aaH_GFR-YU"),
    );
  }
}
...
class PlacePickerState extends State<PlacePicker> {
  ...
  void autoCompleteSearch(String place) async {
    try {
      ...
      var endpoint =
          ...
          "&radius=20000"
          "&region=kr";
      if (this.locationResult?.latLng != null) {
        endpoint +=
            "&location=${locationResult?.latLng?.latitude}%2C${locationResult?.latLng?.longitude}";
      }
  ...
  void getNearbyPlaces(LatLng latLng) async {
    try {
      final url = Uri.parse(
          ...
          "&radius=10000&language=${widget.localizationItem!.languageCode}");
  ...
  Future<bool> _delayedPop() async {
    ...
    TaxiPredictRes taxipredictres =await taxiPredict([
      this.locationResult?.latLng?.latitude,
